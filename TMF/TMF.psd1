@{
	...
	FunctionsToExport = @(
		...
		'Register-TmfDeviceRegistrationPolicy',
		'Test-TmfDeviceRegistrationPolicy',
		'Invoke-TmfDeviceRegistrationPolicy',
		'Export-TmfDeviceRegistrationPolicy',
		'Register-TmfClaimsMappingPolicy',
		'Test-TmfClaimsMappingPolicy',
		'Invoke-TmfClaimsMappingPolicy',
		'Export-TmfClaimsMappingPolicy',
		'Register-TmfActivityBasedTimeoutPolicy',
		'Test-TmfActivityBasedTimeoutPolicy',
		'Invoke-TmfActivityBasedTimeoutPolicy',
		'Export-TmfActivityBasedTimeoutPolicy',
		'Test-TmfPolicy',
		'Invoke-TmfPolicy',
		'Export-TmfPolicy',
		...
		'Export-TmfCustomAuthenticationExtension',
		'Invoke-TmfCustomAuthenticationExtension',
		'Register-TmfCustomAuthenticationExtension',
		'Test-TmfCustomAuthenticationExtension',
