@{
	...
	FunctionsToExport = @('New-TmfConfiguration', 'Get-TmfActiveConfiguration', 'Get-TmfDesiredConfiguration', 'Activate-TmfConfiguration', 'Deactivate-TmfConfiguration', 'Load-TmfConfiguration', 'Register-TmfGroup')
